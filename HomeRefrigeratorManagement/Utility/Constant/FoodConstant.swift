...
extension Constant {
    ...
    enum FoodConstant {
        static var foodIconInfo = [
            ...
            FoodModel(name: "양배추", category: .vegetable),
            FoodModel(name: "양상추", category: .vegetable),
            FoodModel(name: "아스파라거스", category: .vegetable),
            FoodModel(name: "청경채", category: .vegetable),
            FoodModel(name: "콩나물", category: .vegetable),
            FoodModel(name: "파프리카", category: .vegetable),
            FoodModel(name: "파", category: .vegetable),
            FoodModel(name: "피망", category: .vegetable),
            FoodModel(name: "호박", category: .vegetable),
            ...
            FoodModel(name: "아보카도", category: .fruit),
            FoodModel(name: "오렌지", category: .fruit),
            FoodModel(name: "체리", category: .fruit),
            FoodModel(name: "크렌베리", category: .fruit),
            FoodModel(name: "키위", category: .fruit),
            FoodModel(name: "토마토", category: .fruit),
            FoodModel(name: "파인애플", category: .fruit),
            FoodModel(name: "포도", category: .fruit),
            // "곡식"
            FoodModel(name: "귀리", category: .grains),
            FoodModel(name: "쌀", category: .grains),
            // "견과류"
            FoodModel(name: "땅콩", category: .nuts),
            FoodModel(name: "아몬드", category: .nuts),
            FoodModel(name: "잣", category: .nuts),
            FoodModel(name: "캐슈넛", category: .nuts),
            FoodModel(name: "피스타치오", category: .nuts),
            FoodModel(name: "호두", category: .nuts),
            // "육류"
            ...
            FoodModel(name: "양고기", category: .meat),
            FoodModel(name: "오리고기", category: .meat),
            // "수산물"
            ...
            FoodModel(name: "오징어", category: .seafood),
            FoodModel(name: "전복", category: .seafood),
            FoodModel(name: "쭈꾸미", category: .seafood),
            FoodModel(name: "조개", category: .seafood),
            FoodModel(name: "해산물-직접입력", category: .seafood),
            // "양념"
            FoodModel(name: "조미료-직접입력", category: .seasoning),
            // "조미료"
            ...
            FoodModel(name: "케첩", category: .sauce),
            // "면류"
            FoodModel(name: "면-직접입력", category: .noodles),
            // "유제품"
            FoodModel(name: "생크림", category: .dairyProduct),
            FoodModel(name: "연유", category: .dairyProduct),
            FoodModel(name: "요거트", category: .dairyProduct),
            FoodModel(name: "우유", category: .dairyProduct),
            FoodModel(name: "유제품-직접입력", category: .dairyProduct),
            FoodModel(name: "치즈", category: .dairyProduct),
            // "음료"
            FoodModel(name: "주류-직접입력", category: .beverage),
            // "인스턴스"
            FoodModel(name: "참치캔", category: .instance),
            // "과자/제과"
            ...
            FoodModel(name: "식빵", category: .snack),
            // "기타"
